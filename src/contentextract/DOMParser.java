...
import querymaker.QueryManager;
...
public class DOMParser {
	...
	protected Element recordNodeStats(Element elem)
	{
		...
		DensityCalculator calculator=new DensityCalculator(elem, contextDescription, this.bodyTextDensity, this.bodyLinkDensity);
		...
		RelevanceCalculator relcalc=new RelevanceCalculator(elem1, contextDescription, stackTrace, codeContext);
