...
import querymaker.StackTraceElem;
...
public class SCQueryMaker {
	...
	public static void main(String[] args) {
		...
		String strace=ContentLoader.loadFileContent("./data/strace.txt");
		String ccontext=ContentLoader.loadFileContent("./data/ccontext.txt");
		SCQueryMaker maker=new SCQueryMaker("", strace, ccontext);
		String searchQuery=maker.getSearchQuery();
