...
public class SQTester {
	...
	public static void main(String[] args) {
		...
		String query = StaticData.CE_Data_Home + "/completeds/query";
		String strace = StaticData.CE_Data_Home + "/completeds/strace";
		String ccontext = StaticData.CE_Data_Home + "/completeds/ccontext";
